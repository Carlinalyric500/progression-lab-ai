...
const NextChordSuggestionsSection = lazy(() => import('./NextChordSuggestionsSection'));
const ProgressionIdeasSection = lazy(() => import('./ProgressionIdeasSection'));
const StructureSuggestionsSection = lazy(() => import('./StructureSuggestionsSection'));
