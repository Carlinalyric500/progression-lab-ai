...
export const MOOD_LABEL_KEY_BY_VALUE: Record<string, string> = {
  Dreamy: 'options.mood.dreamy',
  Dark: 'options.mood.dark',
  Hopeful: 'options.mood.hopeful',
  Energetic: 'options.mood.energetic',
  Melancholic: 'options.mood.melancholic',
  Happy: 'options.mood.happy',
  Sad: 'options.mood.sad',
  Angry: 'options.mood.angry',
  Calm: 'options.mood.calm',
  Uplifting: 'options.mood.uplifting',
  Emotional: 'options.mood.emotional',
  Peaceful: 'options.mood.peaceful',
  Intense: 'options.mood.intense',
  Mellow: 'options.mood.mellow',
  Bright: 'options.mood.bright',
  Moody: 'options.mood.moody',
  Somber: 'options.mood.somber',
  Playful: 'options.mood.playful',
  Dramatic: 'options.mood.dramatic',
  Romantic: 'options.mood.romantic',
  Mysterious: 'options.mood.mysterious',
  Ethereal: 'options.mood.ethereal',
  Groovy: 'options.mood.groovy',
  Chill: 'options.mood.chill',
  Epic: 'options.mood.epic',
  Whimsical: 'options.mood.whimsical',
  Nostalgic: 'options.mood.nostalgic',
  Vibrant: 'options.mood.vibrant',
  Soulful: 'options.mood.soulful',
  Ambient: 'options.mood.ambient',
  Hypnotic: 'options.mood.hypnotic',
};
